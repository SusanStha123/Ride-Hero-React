              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                <form className="space-y-4 md:space-y-6">
                  <div>
                    ...
                    <input type="password" name="password" id="password" value="" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="••••••••" />
                  </div>
                  <div>
                    <label className="flex items-center mb-2 text-sm font-medium text-gray-900 dark:text-white">
                      <span><FaLock className='text-primary' /></span>
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" value="" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="••••••••" />
                  </div>
                  ...
                  <button onClick={() => {
                    ...
                    <span><HiSave className='ml-2 text-lg font-bold' /></span>
                  </button>
                </form>
              </div>
            </div>
