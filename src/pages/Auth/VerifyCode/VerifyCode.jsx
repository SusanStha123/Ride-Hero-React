              ...
              <form className="space-y-4 md:space-y-6">
                <div>
                  <label className="flex items-center mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    <span><FaCode className='text-primary' /></span>
                    <span className='ml-2'>Email Verification Code</span>
                  </label>
                  <input type="email" name="email" id="email" value="" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="email verification code" />
                </div>
                ...
                <button onClick={() => {
                  ...
                  <span><BiReset className='ml-2 text-xl' /></span>
                </button>
              </form>
            </div>
          </div>
